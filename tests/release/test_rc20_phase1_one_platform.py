...
def test_landing_serves_premium_production_safe():
    ...
    assert "rc20p1" in body or "rc21" in body or "rc22" in body or "rc23" in body
...
def test_home_is_biomed_hub_with_unified_shell():
    ...
    assert "rc21" in body or "rc20p1" in body or "rc22" in body or "rc23" in body
...
def test_executive_integrated_in_one_platform_journey():
    ...
    assert "rc21" in html or "rc22" in html or "rc23" in html
