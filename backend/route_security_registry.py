...
KNOWN_API_PATHS: FrozenSet[str] = frozenset(
    {
        ...
        "/api/executive/analyze/{analysis_id}",
        ...
        "/api/executive/questions",
        "/api/executive/questions/{qid}",
        "/api/export/excel",
        "/api/export/pptx",
        "/api/filtros",
        "/api/filtros-salvos",
        ...
        "/api/preview/ficha/collaborators",
        "/api/preview/ficha/metrics",
        "/api/preview/ficha/alerts",
        "/api/preview/ficha/invites",
        "/api/preview/ficha/invites/{token}",
        "/api/preview/ficha/invites/{token}/send",
        "/api/preview/ficha/invites/{token}/channel",
        "/api/preview/ficha/invites/{token}/validate",
        "/api/preview/ficha/invites/{token}/cancel",
        "/api/preview/ficha/f/{token}",
        "/api/preview/ficha/f/{token}/start",
        "/api/preview/ficha/f/{token}/submit",
